...
// });
// export default pool;
var promise_1 = require("mysql2/promise"); // Change this line
// Create a connection pool to the MySQL database with direct credentials
var pool = (0, promise_1.createPool)({
    host: '107.180.119.179', // Your database host
    user: 'user001', // Your database user
    password: 'tribemeadmin1', // Your database password
    database: 'tribeme', // Your database name
    waitForConnections: true,
    connectionLimit: 10,
    queueLimit: 0,
