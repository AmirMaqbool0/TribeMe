  ...
  return (
    <Box className="flex min-h-screen bg-white relative">
      ...
      <Grid container className="flex-1">
        {/* Left Form Section */}
        <Grid item xs={12} md={7} className="flex justify-center items-center p-6 md:p-8">
          <Box className="w-full max-w-md">
            {/* Back to Login */}
            <Box className="flex items-center mb-8 mt-10">
              ...
              <Link href="/login" passHref>
                <Typography variant="body2" className="ml-2 cursor-pointer text-gray-600">
                  Back to login
                </Typography>
              </Link>
            </Box>
        ...
        {/* Right Image Section */}
        <Grid item xs={12} md={5} className="hidden md:flex justify-center items-center p-4 md:p-8">
          <img src="/forgotPass.png" alt="Forgot Password" className="w-4/5 h-auto object-cover rounded-lg" />
        </Grid>
      </Grid>
    </Box>
  );
